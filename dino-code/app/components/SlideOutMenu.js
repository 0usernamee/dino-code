...
export default function SlideOutMenu({ isOpen, onClose, theme = "default" }) {
      ...
      >
        ...
        <nav className={styles.navigation}>
          <div className={styles.menuItem}>
            <Link href="/lessons" className={styles.menuLink}>
              <span>Lessons</span>
          ...
          <div className={styles.menuItem}>
            <Link href="/friends" className={styles.menuLink}>
              <span>Friends</span>
            </Link>
          </div>
          <div className={styles.menuItem}>
          ...
          <div className={styles.menuItem}>
            <Link href="/leaderboard" className={styles.menuLink}>
